...
Why Alice? Because of the wonderland of the child traversing the logic of sense of the mathematician. Because the last sentence of Sutherland's "Ultimate Display" (1965) spoke that "with appropriate programming such a display could literally be the Wonderland into which Alice walked." Because of the paradoxes in [the logic of sense](https://books.google.co.kr/books?id=PKfBPrRda4sC&redir_esc=y). Not an acronym, if it were, perhaps it could be artificial life & computational experience, or algorithmic immersive and creative enlivement, or augmented live coding embodiment, or aleatory involution center, or atelier-lab of interactive collaborative environments... Moreover it echoes the Greek [allos](http://www.thefreedictionary.com/allo-), source of alias, else, alter, and alien.
