...
Why Alice? Because of the wonderland of the child traversing the paradoxical [the logic of sense](https://books.google.co.kr/books?id=PKfBPrRda4sC&redir_esc=y) of the mathematician. Because the last sentence of Sutherland's "Ultimate Display" (1965) spoke that "with appropriate programming such a display could literally be the Wonderland into which Alice walked." Not an acronym, but if it were perhaps it could be artificial life & interactive computational embodiment, or algorithmic immersive & collaborative enlivement, or augmented live coding environments, etc... Moreover *alice* echoes [*allos*](http://www.thefreedictionary.com/allo-), origin of alias, else, alter, and alien.
